<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Bally_ExpiredMemberDetails.aspx.cs" Inherits="MemberDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table width="100%">
        <tr>
            <td align="left">
                <asp:Label ID="lblWelcomeNote" runat="server" CssClass="data" ForeColor="#0000CC"></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="center">
                        ...
                        <td align="center">
                            <table style="width: 899px; height: 69px;">
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtEmployeeName" runat="server" Width="160px" CssClass="textBox"
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtEmailID" runat="server" Width="160px" CssClass="textBox" TabIndex="5"
                                            Enabled="False"></asp:TextBox>
                                ...
                                <%-- <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtAccountNo" runat="server" Width="130px" CssClass="textBox" TabIndex="1"
                                            Enabled="False"></asp:TextBox>
                                    </td>
                                    <td class="label" align="left">
                                        Bank Name
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtBankName" runat="server" Width="200px" CssClass="textBox" TabIndex="1"
                                            Enabled="False"></asp:TextBox>
                                    </td>
                                    <td align="left" class="label">
                                        IFSC Code
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtIfscCode" runat="server" Width="100px" CssClass="textBox" TabIndex="1"
                                            Enabled="False"></asp:TextBox>
                                    </td>
                                </tr>--%>
                            </table>
                    ...
                    <tr>
                        <td align="center" colspan="6" bgcolor="White" style="height: 35px;">
                            <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="button" Width="78px"
                                TabIndex="7" OnClick="btnSave_Click" ValidationGroup="main" Enabled="False" />
        ...
        <tr>
            <td align="center">
                ...
                <asp:GridView ID="grdOldMemberDetails" runat="server" AutoGenerateColumns="False"
                    BorderColor="Navy" BorderWidth="1px" CellPadding="4" CssClass="data" ForeColor="#333333"
                    GridLines="None" Width="866px">
        ...
        <tr>
            <td align="center">
                ...
                <table class="label" style="width: 959px; height: 95px; background-color: #B2B2B2"
                    border="1">
                    <tr>
                        <td align="center">
                            <table style="width: 937px; height: 60px;">
                                <tr>
                                    <td>
                                        Name
                                    </td>
                                    ...
                                    <td id="tdMarriageDate" runat="server" visible="false">
                                        DateOfMarriage<br />
                                        <asp:Label ID="Label5" runat="server" Font-Bold="false" Font-Size="XX-Small" Text="(dd/mm/yyyy)"></asp:Label>
                                    </td>
                                    <td>
                                        DateOfBirth<br />
                                        <asp:Label ID="Label4" runat="server" Font-Bold="false" Font-Size="XX-Small" Text="(dd/mm/yyyy)"></asp:Label>
                                    </td>
                                    <td>
                                        Age
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <asp:TextBox ID="txtGender" runat="server" CssClass="textBoxDate" TabIndex="11" Width="90px"></asp:TextBox>
                                    ...
                                    <td align="center" id="tdMarriageDate1" runat="server" visible="false">
                                        <asp:TextBox ID="txtMarriageDate" runat="server" CssClass="textBoxDate" Width="100px"></asp:TextBox>
                                    ...
                                    <td align="center">
                                        <asp:TextBox ID="txtDateOfBirth" runat="server" CssClass="textBoxDate" TabIndex="12"
                                            ControlToValidate="txtDateOfBirth" Width="90px"></asp:TextBox>
                                    ...
                                    <td align="center">
                                        <asp:TextBox ID="txtAge" runat="server" CssClass="textBoxDate" TabIndex="13" Width="70px"></asp:TextBox>
                                    ...
                                    <td align="center">
                                        <asp:TextBox ID="txtAgeType" runat="server" CssClass="textBoxDate" TabIndex="14"
                    ...
                    <tr>
                        <td align="center" bgcolor="White" style="height: 35px;">
        ...
        <tr>
            <td align="center">
                ...
                <asp:GridView ID="grdDependentdetails" runat="server" CellPadding="4" ForeColor="#333333"
                    GridLines="None" Width="826px" AutoGenerateColumns="False" CssClass="data" BorderColor="Navy"
                    BorderWidth="1px">
                    <RowStyle BackColor="#EFF3FB" />
                    <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                    <PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" />
                    ...
                    <tr>
                        <td align="left" style="height: 25px; width: 900px;">
                            <asp:CheckBox ID="chkPolicyTerms" runat="server" Text="I am aware that dependent enrollment happens only once a year and the health insurance policy will not allow for any mid-term inclusions (Except by way of “natural” additions during the course of the policy - by way of marriage or child-birth)."
                                ...
                                oncheckedchanged="chkPolicyTerms_CheckedChanged" />
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td align="center">
                <asp:Button ID="btnConfirm" runat="server" Text="Confirm" CssClass="button" TabIndex="16"
                    OnClick="btnConfirm_Click" ValidationGroup="main" OnClientClick="Validation()"/>
               <%-- <asp:ConfirmButtonExtender ID="btnConfirm_ConfirmButtonExtender" runat="server" ConfirmText="Please note : Once the data is confirmed no online corrections/modifications will be allowed. Please check the data once again and then click “OK” button to proceed"
                    Enabled="True" TargetControlID="btnConfirm">
                </asp:ConfirmButtonExtender>--%>
            </td>
        </tr>
        <tr>
