<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="TBSL_HR.aspx.cs" Inherits="TBSL_HR" %>
                ...
                <table style="width: 806px; height: 297px; background-image: url('images/TableBack.jpg')">
                    <tr>
                        <td align="center">
                            ...
                            <br />
                            <br />
                            <table style="width: 554px; height: 71px;" class="label">
                                <tr>
                                    <td align="right">
                                        EmployeeID
                                    </td>
                                ...
                                <tr>
                                    <td class="style2" colspan="2" align="center">
                                        <br />
                                        <asp:Button ID="BtnUnlock" runat="server" Text="Unlock" CssClass="button" 
                                            OnClick="BtnUnlock_Click" Width="110px" />
                                        &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                                        <asp:Button ID="btnGetDetails" runat="server" Text="Get Details" CssClass="button"
                                            OnClick="btnGetDetails_Click" />
                                            &nbsp;&nbsp;&nbsp;
                                            &nbsp;
                                            <asp:Button ID="btnAdddependent" runat="server" Text="Add Dependent" CssClass="button"
                                            Width="130px" onclick="btnAdddependent_Click"   />
                                    </td>
                                </tr>
                            </table>
                        </td>
